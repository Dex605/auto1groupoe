...
const CARS = [
  ...
  { id:3,  name:'Audi A8',                  cat:'Luxury Sedan',    img:'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600&q=80', price:'$88,000',  rating:4.7 },
  { id:4,  name:'Lexus LS 500',             cat:'Luxury Sedan',    img:'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=600&q=80', price:'$78,000',  rating:4.7 },
  { id:5,  name:'Genesis G90',              cat:'Luxury Sedan',    img:'https://images.unsplash.com/photo-1617788138017-80ad40651399?w=600&q=80', price:'$92,000',  rating:4.6 },
  ...
  { id:12, name:'Mercedes GLS 600',         cat:'Luxury SUV',      img:'https://images.unsplash.com/photo-1618843479619-f3d0d81e4d10?w=600&q=80', price:'$165,000', rating:4.8 },
  ...
  { id:16, name:'Jeep Wrangler Rubicon',    cat:'Off-Road SUV',    img:'https://images.unsplash.com/photo-1564207581086-b2e75bc3f9ef?w=600&q=80', price:'$52,000',  rating:4.5 },
  { id:17, name:'Toyota Land Cruiser 300',  cat:'Off-Road SUV',    img:'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80', price:'$88,000',  rating:4.8 },
  ...
  { id:24, name:'Bugatti Chiron',           cat:'Hypercar',        img:'https://images.unsplash.com/photo-1617814076668-8dfc6fe3b744?w=600&q=80', price:'$3,200,000',rating:5.0 },
  ...
  { id:27, name:'Mercedes EQS 580',        cat:'Electric',        img:'https://images.unsplash.com/photo-1617788138017-80ad40651399?w=600&q=80', price:'$125,000', rating:4.8 },
  { id:28, name:'Rivian R1T',              cat:'Electric Truck',  img:'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600&q=80', price:'$73,000',  rating:4.6 },
  { id:29, name:'Ford F-150 Raptor',       cat:'Performance Truck',img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', price:'$68,000',  rating:4.7 },
  { id:30, name:'RAM 1500 TRX',            cat:'Performance Truck',img:'https://images.unsplash.com/photo-1563720223185-11003d516935?w=600&q=80', price:'$72,000',  rating:4.7 },
  ...
  { id:34, name:'Maserati Quattroporte',   cat:'Italian Luxury',  img:'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600&q=80', price:'$115,000', rating:4.7 },
  { id:35, name:'Alfa Romeo Giulia QV',    cat:'Italian Sport',   img:'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&q=80', price:'$82,000',  rating:4.6 },
  { id:36, name:'Jaguar F-Type R',         cat:'British Sport',   img:'https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?w=600&q=80', price:'$105,000', rating:4.7 },
  { id:37, name:'Volvo XC90 Recharge',     cat:'Luxury SUV',      img:'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80', price:'$78,000',  rating:4.6 },
  { id:38, name:'Infiniti QX80',           cat:'Full-Size SUV',   img:'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=600&q=80', price:'$72,000',  rating:4.4 },
  ...
  { id:40, name:'Koenigsegg Jesko',        cat:'Hypercar',        img:'https://images.unsplash.com/photo-1617814076668-8dfc6fe3b744?w=600&q=80', price:'$3,000,000',rating:5.0 },
];
